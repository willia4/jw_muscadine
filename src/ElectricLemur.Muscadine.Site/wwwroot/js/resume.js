document.addEventListener("DOMContentLoaded", () => {
    function findAnnotations() {
        ...
        const headerContainers = Array.from(document.getElementsByClassName("header-container"));
        ...
        return asides.map(aside => {
            ...
            return {
                sid: sid,
                aside: aside,
                section: sections.find(s => s.dataset.sid === sid),
                sectionContainer: sectionContainers.find(s => s.dataset.sid === sid),
                headerContainer: headerContainers.find(s => s.dataset.sid === sid)
            };
        });
    }
    ...
    function configureAnnotation(annotation) {
        ...
        if (annotation.headerContainer) {
            annotation.headerContainer.appendChild(toggleButton);
        }
